              ...
              <div class="container container-large">
                <div class="details-intro-thumb-wrapper">
                  <div class="details-intro-thumb">
                    <img src="{{ url('assets/imgs/gallery/bilan_competences1.jpg') }}" alt="service image">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="container container-large">
                  ...
                  <div class="details-content has_fade_anim">
                    <div class="section-title-wrapper">
                      <div class="title-wrapper">
                        <h2 class=" details-title section-title">Evaluez vos vraies compétences !</h2>
                      </div>
                    </div>
                    <div class="text-wrapper">
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Nos offres en bilan de compétences</h3>
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Que Propose EHC en bilan de compétences ?</h3>
                      <div class="feature-list-wrapper">
                ...
                <!--    <div class=" btn-wrapper">
                  ...
                  <div class="thumb has_fade_anim" data-fade-from="right">
                    <img src="{{ url('assets/imgs/gallery/bilan_competences2.jpg') }}" alt="service image">
                  </div>
                </div>
              </div>
            </div>
