...
<head>
  ...
  <title> service de recruitement</title>
                  ...
                  <div class="details-intro-inner">
                    ...
                    <div class="details-intro-content">
                      <div class="title-box">
                        <div class="section-title-wrapper">
                          ...
                          <div class="title-wrapper has_fade_anim">
                            <h1 class="section-title details-title large">EHC RECRUITMENT</h1>
                          </div>
                        </div>
                      </div>
                      <div class="text-box">
                      ...
                      <!--   <div class="btn-wrapper has_fade_anim">
                        ...
                        <div class="btn-wrapper has_fade_anim">
                    <a href="contact.html" style="background-color:#005153; border:none;" class="wc-btn-primary btn-text-flip"><span data-text="Recruitment platform">Visitez la plateforme</span><i class="fa-solid fa-play"></i></a>
                  </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="container container-large">
                <div class="details-intro-thumb-wrapper">
                  <div class="details-intro-thumb">
                    <img src="{{ url('assets/imgs/gallery/recruitement1.jpeg') }}" alt="service image">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="container container-large">
                <div class="details-content-area-inner">
                  <div class="details-content has_fade_anim">
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Nos offres de recruitement</h3>
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Que Propose EHC Recruitment ?</h3>
                      <div class="feature-list-wrapper">
                ...
                <!--    <div class=" btn-wrapper">
                  ...
                  <div class="thumb has_fade_anim" data-fade-from="right">
                    <img src="{{ url('assets/imgs/gallery/recruitement2.jpg') }}" alt="service image">
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="section-content">
                    <div class="counter-box-wrapper">
                      ...
                      <div class="counter-box">
                        ...
                        <h3 class="text has_fade_anim">années d'expérience</h3>
                      </div>
                    </div>
                  </div>
                </div>
