                      ...
                      <div class="title-box">
                        <div class="section-title-wrapper">
                          ...
                          <div class="title-wrapper has_fade_anim">
                            <h1 class="section-title details-title large">COACHING D'EMPLOI</h1>
                          </div>
                        </div>
                      </div>
                      <div class="text-box">
                  ...
                  <div class="details-content has_fade_anim">
                    <div class="section-title-wrapper">
                      <div class="title-wrapper">
                        <h2 class=" details-title section-title">S'intégrez facilement dans votre entreprise  !</h2>
                      </div>
                    </div>
                    <div class="text-wrapper">
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Nos offres en coaching d'emploi</h3>
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Que Propose EHC en coaching d'emploi ?</h3>
                      <div class="feature-list-wrapper">
            ...
            <!--   <p class="text">Myriam was first trained as a sculptor in Montreal and then in Helsinki, Finland. She is
              ...
              <div class="experience-area">
                <div class="experience-area-bg">
                  <img src="{{ url('assets/imgs/gallery/emploi3.jpg') }}" alt="gallery">
                </div>
                <div class="container">
