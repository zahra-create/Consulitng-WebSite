...
<head>
  ...
  <title> service de formation</title>
                  ...
                  <div class="details-intro-inner">
                    ...
                    <div class="details-intro-content">
                      <div class="title-box">
                        <div class="section-title-wrapper">
                          ...
                          <div class="title-wrapper has_fade_anim">
                            ...
                            <h1 class="section-title details-title large">E-LEARNING </h1>
                          </div>
                        </div>
                      </div>
                      <div class="text-box">
                      ...
                      <!--   <div class="btn-wrapper has_fade_anim">
                        <a class="details-text cf_btn wc-btn-underline btn-text-flip" href="#"><span  data-text="Platefrome de recruitement">Notre plateforme de
                           recruitement
                          </span><i class="fa-solid fa-caret-right"></i></a>  
                        </div>  -->
                        <div class="btn-wrapper has_fade_anim">
                    <a href="contact.html" style="background-color:#005153; border:none;" class="wc-btn-primary btn-text-flip"><span data-text="E-learning platform">Visitez la plateforme</span><i class="fa-solid fa-play"></i></a>
                  </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="container container-large">
                <div class="details-intro-thumb-wrapper">
                  <div class="details-intro-thumb">
                    <img src="{{ url('assets/imgs/gallery/e-learning1.jpg') }}" alt="service image">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="container  container-large">
                  ...
                  <div class="details-content has_fade_anim">
                    <div class="section-title-wrapper">
                      <div class="title-wrapper">
                        <h2 class=" details-title section-title">Recrutez les Meilleurs Talents !</h2>
                      </div>
                    </div>
                    <div class="text-wrapper">
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Nos offres de formation</h3>
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Que Propose EHC e-learning ?</h3>
                      <div class="feature-list-wrapper">
                ...
                <!--    <div class=" btn-wrapper">
                  ...
                  <div class="thumb has_fade_anim" data-fade-from="right">
                    <img src="{{ url('assets/imgs/gallery/e-learning2.jpeg') }}" alt="service image">
                  </div>
                </div>
              </div>
            </div>
            ...
            <!--   <p class="text">Myriam was first trained as a sculptor in Montreal and then in Helsinki, Finland. She is
              ...
              <div class="experience-area">
                <div class="experience-area-bg">
                  <img src="{{ url('assets/imgs/gallery/e-learning3.jpg') }}" alt="gallery">
                </div>
                <div class="container">
                  <div class="section-content">
                    <div class="counter-box-wrapper">
                      ...
                      <div class="counter-box">
                        ...
                        <h3 class="text has_fade_anim">années 
                        d'expérience</h3>
                      </div>
                    </div>
                  </div>
