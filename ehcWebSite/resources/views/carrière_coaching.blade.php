...
<head>
  ...
  <title> Coaching de carrière</title>
              ...
              <div class="container container-large">
                <div class="details-intro-thumb-wrapper">
                  <div class="details-intro-thumb">
                    <img src="{{ url('assets/imgs/gallery/coaching_carrière1.jpg') }}" alt="service image">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="container container-large">
                  ...
                  <div class="details-content has_fade_anim">
                    <div class="section-title-wrapper">
                      <div class="title-wrapper">
                        <h2 class=" details-title section-title">Obtenez le job adapté à votre profil !</h2>
                      </div>
                    </div>
                    <div class="text-wrapper">
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Nos offres en coaching de carrière</h3>
                    ...
                    <div class="details-feature-content">
                      <h3 class="details-title title">Que Propose EHC en coaching de carrière ?</h3>
                      <div class="feature-list-wrapper">
                ...
                <!--    <div class=" btn-wrapper">
                  ...
                  <div class="thumb has_fade_anim" data-fade-from="right">
                    <img src="{{ url('assets/imgs/gallery/coaching_carrière2.jpeg') }}" alt="service image">
                  </div>
                </div>
              </div>
            </div>
            ...
            <!--   <p class="text">Myriam was first trained as a sculptor in Montreal and then in Helsinki, Finland. She is
              ...
              <div class="experience-area">
                <div class="experience-area-bg">
                  <img src="{{ url('assets/imgs/gallery/coaching_carrière3.jpg') }}" alt="gallery">
                </div>
                <div class="container">
